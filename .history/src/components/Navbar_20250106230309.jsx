...
const Navbar = () => {
  ...
  return (
    <header className="z-20 sm:absolute top-0 left-0 w-full">
      <div className="hidden px-[5rem] sm:flex flex-wrap p-5 flex-col md:flex-row  gap-6 items-center pb-16">
        ...
        <a
          href="/"
          className="flex cursor-pointer order-first lg:order-none lg:w-1/5 title-font font-medium  text-gray-900 lg:items-center lg:justify-center mb-4 md:mb-0"
        >
